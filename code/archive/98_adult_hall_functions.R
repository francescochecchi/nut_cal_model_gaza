...
### Function to estimate fat mass (Kg), based on weight (Kg), height (m),
  # age and sex; from Hall KD, Sacks G, Chandramohan D, et al.
...
#...............................................................................
### Function encoding adult weight loss model:
...
f_hall_adults <- function(data = df, f_fat_f = f_fat) {
...
#    alpha <- forbes / f_start  # simplification for modest weight gain (unused)
      ...
      if (sex == "male") {f_now <- (weight / 100) * (0.14 * age + 37.31 *
        log(weight / (height^2)) - 103.94)
      }
      if (sex == "female") {f_now <- (weight / 100) * (0.14 * age + 39.96 *
...
#...............................................................................
### Function to estimate resting metabolic rate (rmr) among adults
...
f_rmr <- function(data = df_ad) {
  ...
  # Females
  if (sex == "female")
  {out <- 9.99 * weight + 6.25 * height - 4.92 * age - 161}

  # Males
  if (sex == "male")
  {out <- 9.99 * weight + 6.25 * height - 4.92 * age + 5}
